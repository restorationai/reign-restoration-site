...
priority: 9.0
plan_hash: "a86abf2b49233beb"
generated_at: "2026-08-03T16:28:31.131531+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/fate-tx/fire-damage-restoration/", "/service-areas/garland-tx/fire-damage-restoration/", "/service-areas/greenville-tx/fire-damage-restoration/", "/service-areas/mesquite-tx/fire-damage-restoration/", "/service-areas/rockwall-tx/fire-damage-restoration/", "/service-areas/rowlett-tx/fire-damage-restoration/", "/service-areas/royse-city-tx/fire-damage-restoration/", "/service-areas/terrell-tx/fire-damage-restoration/", "/service-areas/wylie-tx/fire-damage-restoration/", "/blog/choosing-a-restoration-company/", "/blog/fire-damage-restoration-process/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Fire Damage Restoration"}]
faq: [{"question": "What's the difference between protein soot and synthetic soot, and why does it change how my home gets cleaned?", "answer": "Protein soot comes from burned organic material \u2014 food, hair, natural fibers \u2014 and leaves almost no visible residue, but it produces a powerful, persistent odor and bonds tightly to painted and varnished surfaces. Synthetic soot from burning plastics, foam, or insulation is dark, oily, and smeared, and it requires chemical solvents rather than dry-cleaning methods. Using the wrong technique on either type can permanently embed the residue into the substrate, which is why characterizing the soot before touching anything is the first step in a proper fire restoration scope."}, {"question": "Why does my home still smell like smoke after another company said the cleanup was done?", "answer": "Smoke odor that returns \u2014 especially in warm weather \u2014 almost always means the deodorization process didn't reach the same spaces the smoke did. Smoke travels through wall cavities, HVAC systems, and subfloor spaces; wiping down surfaces and repainting without treating those hidden areas leaves odor compounds intact. A complete fire restoration scope includes thermal fogging or hydroxyl/ozone treatment to break down odor at the molecular level inside wall and ceiling cavities, not just on visible surfaces."}, {"question": "Does homeowners insurance cover fire damage restoration?", "answer": "Yes \u2014 accidental fire damage is one of the core covered perils in a standard homeowners policy, and coverage typically includes structural repairs, smoke and soot cleaning, contents restoration, and additional living expenses if the home is uninhabitable. Reign Restoration works with all insurance carriers and handles the claim documentation \u2014 scope of work, photo evidence, contents inventory, and direct billing \u2014 so you are not managing the paperwork while also managing the loss."}, {"question": "What happens to my furniture and belongings during fire restoration?", "answer": "Salvageable contents are packed out, inventoried with photos and pre-loss value documentation, and transported to a controlled environment for cleaning. Depending on the material, items are cleaned using ultrasonic tanks, ozone chambers, or dry-cleaning methods. The pack-out inventory becomes part of your insurance claim documentation, which is important \u2014 a detailed contents list with condition notes before and after cleaning is one of the primary things adjusters use to settle the personal property portion of a fire claim."}, {"question": "How do I know what's structurally safe to stay in after a fire, and can I be in the home during restoration?", "answer": "Structural safety after a fire depends on where the fire burned and how long \u2014 charred framing loses load-bearing capacity, and smoke-damaged HVAC systems can circulate carbon and particulate through a home that looks intact. Whether any portion of the home is safe to occupy during restoration is a determination made on-site based on the specific damage; Reign Restoration will give you a clear answer during the initial walkthrough. In most cases involving significant smoke spread or structural involvement, temporary relocation is both safer and faster \u2014 and your homeowners policy's additional living expense coverage typically applies."}]
...
Insurance adjusters also look for a complete contents inventory with pre-loss value documentation. Restoration companies that skip the pack-out or document contents loosely leave money on the table for the homeowner and create disputes during settlement.
...
|---|---|
| Single room, limited smoke spread | $3,000 – $8,000 |
| Multi-room smoke damage, no structural loss | $8,000 – $20,000 |
| Kitchen fire with cabinet and drywall replacement | $15,000 – $35,000 |
